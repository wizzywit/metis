            ...
            <div class="row">
                <div class="col-xl-4 col-md-6 col-lg-4">
                    <div class="footer_widget">
                        <div class="footer_logo">
                            <a href="#">
                                <img src="{{ asset('images/admin/admin-logo.jpg') }}" alt="" style="width:45px; border-radius: 50px;"><strong class="text-white">  Metis Technologies</strong>
                            </a>
                        </div>
                        <p>
                ...
                <div class="col-xl-3 col-md-6 col-lg-3">
                    <div class="footer_widget">
                        ...
                        <p>
                            200, D-block, Green lane Nigeria <br>
                            +10 367 467 8934 <br>
                            metis@contact.com
                        </p>
                    </div>
