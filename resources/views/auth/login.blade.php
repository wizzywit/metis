			...
			<div class="wrap-login100 p-l-85 p-r-85 p-t-55 p-b-55">
				<form class="login100-form validate-form flex-sb flex-w" method="POST" action="{{ route('login') }}">
					...
					<span class="login100-form-title p-b-32">
                        <h6 style="margin-bottom: -20px"><img src="{{ asset('images/admin/logo1.png') }}" alt="" style="width:45px; "> Metis Technologies</h6><br/> 
                        Patient Login
                        <br/>
                        <br/>
                        <p>
                            Book a visit, book an online appointment, and communicate with doctor's online
                        </p>
					</span>
					...
					<div class="flex-sb-m w-full p-b-48">
						<div class="contact100-form-checkbox">
							<input name="remember" class="input-checkbox100" id="ckb1" type="checkbox" {{ old('remember') ? 'checked' : '' }}>
