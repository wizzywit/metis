            ...
            <div class="content">
                ...
                <div class="module">
                    ...
                    <div class="module-body">
                        ...
                        <form id="formValid" class="form-horizontal row-fluid" method="post" action="{{route('doctor.video.conference')}}">
                                @csrf
                                <div class="control-group">
                                    <label class="control-label" for="basicinput">Select Room</label>
                                    <div class="controls">
                                ...
                                <div class="control-group">
                                    <div class="controls">
                                        <button type="submit" class="btn btn-success">Initiate Video Conference</button>
                                    </div>
                                </div>
                        </form>
                        <div id="render">
