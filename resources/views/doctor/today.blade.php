                   ...
                   <div class="module">
                       ...
                       <div class="module-body">
                           ...
                           <div class="row-fluid">
                               ...
                               <div>
                                    <p style="display: flex; align-content: center; justify-content: center;">No Available Appointments For today</p>
                               </div>
                               @endif
                                ...
                                <div class="media user">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <div class="media-option btn-group shaded-icon">
                                            ...
                                            <button class="btn btn-small btn-success" title="Begin" onclick="event.preventDefault();
