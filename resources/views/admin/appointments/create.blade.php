          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Create an Appointment</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              @if (count($errors) > 0)
              ...
              @if(Session::has('flash_message_error'))
                ...
                @endif
              <form role="form" id="quickForm" action="{{ route('admin.appointment.save') }}" method="post">
              @csrf
              ...
              <div class="card-body">
                  ...
                  <div class="bootstrap-timepicker">
                    <div class="form-group">
                      ...
                      <div class="input-group date" id="timepicker" data-target-input="nearest">
                        <input name="start_time" id="start_time" type="text" class="form-control datetimepicker-input" data-toggle="datetimepicker" data-target="#start_time"/>
                  ...
                  <div class="bootstrap-timepicker" id="e_time">
                    <div class="form-group">
                      ...
                      <div class="input-group date" id="timepicker" data-target-input="nearest">
                        <input name="end_time" id="end_time" type="text" class="form-control datetimepicker-input" data-toggle="datetimepicker" data-target="#end_time"/>
